...
class mainWindow(QMainWindow):
    ...
    def load(self):
        ...
        df.drop(['File Index', 'Test Number', 'Period (Range)', 'DVDD (Range)', 'VDD (Range)', 'Result'], axis=1,
                inplace=True)
    ...
    def mem_vmin_data_ema(self):
        ...
        ax = fig.add_subplot(111)
        ax.set(xlabel='Vdd(V)', ylabel='probability of pass(%)',
               title='Probability plot for <' + mem_instance + '> at Temp = ' + str(temp) + chr(
                   176) + 'C' + ' for ' + split)
    ...
    def mem_vmin_data_instance(self):
        ...
        while (tail_index < len(mem_list)):
            ...
            ax = fig.add_subplot(111)
            ax.set(xlabel='Vdd(V)', ylabel='probability of pass(%)',
                   title='Probability plot for all mem_instances at ema = ' + default_ema + ',Temp = ' + str(
                       temp) + chr(176) + 'C' + ' for ' + split)
        ...
        ax = fig.add_subplot(111)
        ax.set(xlabel='Vdd(V)', ylabel='probability of pass(%)',
               title='Probability plot for all mem_instances at ema = ' + default_ema + ',Temp = ' + str(temp) + chr(
                   176) + 'C' + ' for ' + split)
